...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public void DesfazMovimento(Posicao origem, Posicao destino, Peca pecaCapurda)
        {
            Peca p = Tab.RetirarPeca(destino);
            p.DecrementarQteMovimentos();
            if (pecaCapurda != null)
            {
                Tab.ColocarPeca(pecaCapurda, destino);
                Capturadas.Remove(pecaCapurda);
            }
            ...
            if (p is Peao)
            {
                if (origem.Coluna != destino.Coluna && pecaCapurda == VulneravelEnPassant)
                {
